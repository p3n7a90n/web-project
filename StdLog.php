...
if(isset($_POST['login'])){
	...
	if($error) echo "There were error(s) while login ".$error;
		...
		$query="select * from `students` where usn= '".mysqli_real_escape_string($link,$_POST['uname'])."' and password= '".$_POST['psw']."'";
               echo $query;
...
<h2 style="font-size: 70px;text-align: center;">Students Login Form</h2>
...
<form method="post">
  ...
  <div class="container"  style="margin-left: 15em;">
    ...
    <div class="button3">
    <a href="TchLog.php">Login As Teacher</a>
  </div>
  </div>

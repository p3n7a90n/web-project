...
$link= mysqli_connect("localhost","web","test","web");
 ...
 //echo $rand3;
   $rand4=rand(16,20);
 //echo $rand4;
   $que1="select * from `s1` where qno=".$rand1." and marks=2";
  

   $que2="select * from `s1` where qno=".$rand2." and marks=5";
   $que3="select * from `s1` where qno=".$rand3." and marks=6";
   $que4="select * from `s1` where qno=".$rand4." and marks=8";
...
//Insert Query of SQL
$query1 = "insert into `answers` (usn,date,subject,answers,qno,marks) values ('$usn','$date','S1','$answer1','$rand1',2)";
echo $query1;
...
$query2 = "insert into `answers` (usn,date,subject,answers,qno,marks)  values ('$usn','$date','S1','$answer2','$rand2',5)";
if(!mysqli_query($link,$query2))
{ $flag=0;
 echo "<p>Insertion Failed For 2nd Answer <br/> Some Fields are Blank....!!</p>";
}
$query3 = "insert into `answers` (usn,date,subject,answers,qno,marks)  values ('$usn','$date','S1','$answer3','$rand3',6)";
if(!mysqli_query($link,$query3))
{  $flag=0;
  echo "<p>Insertion Failed For 3rd Annwer <br/> Some Fields are Blank....!!</p>";
}
$query4 = "insert into `answers` (usn,date,subject,answers,qno,marks)  values ('$usn','$date','S1','$answer4','$rand4',8)";
